...
QUEUE_URL="http://localhost:4566/000000000000/payment-callback-queue"
  ...
  --message-body "$(cat <<EOF
{
  ...
  "payload": {
    ...
    "transactinId": "c2f3d9a2-7e94-4f1f-bc4d-8bcb8f25e911",
  ...
  "history": [
    ...
    },
    {
      "source": "PAYMENT",
      "status": "ROLLBACK_PENDING",
      "message": "Rollback do pagamento pendente",
      "createdAt": "2025-12-21T23:30:00"
    }
  ]
}
